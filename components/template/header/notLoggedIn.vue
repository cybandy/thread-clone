...
<template>
  <UContainer
    ...
    <Transition name="fade">
      <div v-show="y <= 50 || notMobile" class="flex items-center justify-center md:justify-start w-full md:p-0">
    ...
    <div class="flex-grow w-full flex gap-3 items-center md:justify-end">
      <div class="flex-grow md:flex-grow-0">
        <ClientOnly>
          <UButton color="black" :variant="!notMobile ? 'outline' : 'solid'" label="Log in" to="/login"
            :block="!notMobile" :ui="{ variant: { outline: 'ring-current' } }" />
          <template #fallback>
